...
public class LiveActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initViewsAndListeners_live();
    }

    private void initViewsAndListeners_live(){
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.tvLocals:
                Intent intentLocalActivity = new Intent(LiveActivity.this, LocalActivity.class);
                this.startActivity(intentLocalActivity);
                break;
            case R.id.tvChat:
                Intent intentChatActivity = new Intent(LiveActivity.this, ChatActivity.class);
                this.startActivity(intentChatActivity);
                break;
            case R.id.tvMatch:
                Intent intentMatchActivity = new Intent(LiveActivity.this, MatchActivity.class);
                this.startActivity(intentMatchActivity);
                break;
            case R.id.tvNearby_live:
                Intent intentNearbyActivity = new Intent(LiveActivity.this, NearBy_Live.class);
                this.startActivity(intentNearbyActivity);
                break;
            case R.id.tvDate_live:
                Intent intentDateActivity = new Intent(LiveActivity.this, Date_Live.class);
                this.startActivity(intentDateActivity);
                break;
            case R.id.tvNew_live:
                Intent intentNewActivity = new Intent(LiveActivity.this, New_Live.class);
                this.startActivity(intentNewActivity);
                break;
            case R.id.tvFavourites_live:
                Intent intentFavouriteActivity = new Intent(LiveActivity.this, Favourite_Live.class);
                this.startActivity(intentFavouriteActivity);
                break;
            case R.id.tvLeaderBoard_live:
                Intent intentLeaderBoardActivity = new Intent(LiveActivity.this, LeaderBoard_Live.class);
                this.startActivity(intentLeaderBoardActivity);
                break;
            case R.id.tvMe:
                Intent intentMeActivity = new Intent(LiveActivity.this, MeActivity.class);
