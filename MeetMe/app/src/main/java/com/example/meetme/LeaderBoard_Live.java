...
public class LeaderBoard_Live extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_leader_board__live);

        initViewsAndListeners_leaderBoard_live();
    }

    private void initViewsAndListeners_leaderBoard_live(){
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.tvLocals:
                Intent intentLocalActivity = new Intent(LeaderBoard_Live.this, LocalActivity.class);
                this.startActivity(intentLocalActivity);
                break;
            case R.id.tvChat:
                Intent intentChatActivity = new Intent(LeaderBoard_Live.this, ChatActivity.class);
                this.startActivity(intentChatActivity);
                break;
            case R.id.tvMatch:
                Intent intentMatchActivity = new Intent(LeaderBoard_Live.this, MatchActivity.class);
                this.startActivity(intentMatchActivity);
                break;
            case R.id.tvTrending_live:
                Intent intentTrendingActivity = new Intent(LeaderBoard_Live.this, LiveActivity.class);
                this.startActivity(intentTrendingActivity);
                break;
            case R.id.tvNearby_live:
                Intent intentNearByActivity = new Intent(LeaderBoard_Live.this, NearBy_Live.class);
                this.startActivity(intentNearByActivity);
                break;
            case R.id.tvDate_live:
                Intent intentDateActivity = new Intent(LeaderBoard_Live.this, Date_Live.class);
                this.startActivity(intentDateActivity);
                break;
            case R.id.tvNew_live:
                Intent intentNewActivity = new Intent(LeaderBoard_Live.this, New_Live.class);
                this.startActivity(intentNewActivity);
                break;
            case R.id.tvFavourites_live:
                Intent intentFavouriteActivity = new Intent(LeaderBoard_Live.this, Favourite_Live.class);
                this.startActivity(intentFavouriteActivity);
                break;
            case R.id.tvMe:
                Intent intentMeActivity = new Intent(LeaderBoard_Live.this, MeActivity.class);
