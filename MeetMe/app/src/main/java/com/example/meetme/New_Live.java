...
public class New_Live extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initViewsAndListeners_new_live();
    }

    private void initViewsAndListeners_new_live(){
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.tvLocals:
                Intent intentLocalActivity = new Intent(New_Live.this, LocalActivity.class);
                this.startActivity(intentLocalActivity);
                break;
            case R.id.tvChat:
                Intent intentChatActivity = new Intent(New_Live.this, ChatActivity.class);
                this.startActivity(intentChatActivity);
                break;
            case R.id.tvMatch:
                Intent intentMatchActivity = new Intent(New_Live.this, MatchActivity.class);
                this.startActivity(intentMatchActivity);
                break;
            case R.id.tvTrending_live:
                Intent intentTrendingActivity = new Intent(New_Live.this, LiveActivity.class);
                this.startActivity(intentTrendingActivity);
                break;
            case R.id.tvNearby_live:
                Intent intentNearByActivity = new Intent(New_Live.this, NearBy_Live.class);
                this.startActivity(intentNearByActivity);
                break;
            case R.id.tvDate_live:
                Intent intentDateActivity = new Intent(New_Live.this, Date_Live.class);
                this.startActivity(intentDateActivity);
                break;
            case R.id.tvFavourites_live:
                Intent intentFavouriteActivity = new Intent(New_Live.this, Favourite_Live.class);
                this.startActivity(intentFavouriteActivity);
                break;
            case R.id.tvLeaderBoard_live:
                Intent intentLeaderBoardActivity = new Intent(New_Live.this, LeaderBoard_Live.class);
                this.startActivity(intentLeaderBoardActivity);
                break;
            case R.id.tvMe:
                Intent intentMeActivity = new Intent(New_Live.this, MeActivity.class);
